...
url = "https://en.wikipedia.org/wiki/List_of_countries_by_life_expectancy#United_Nations_(2021)"
...
with open("life_expectancy.csv", mode='a', encoding='utf-8', newline='') as csvfile:
